...
class TransactionTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_type" do
    assert_difference('TransactionType.count') do
      post transaction_types_url, params: { transaction_type: { description: @transaction_type.description, kind: @transaction_type.kind, sign: @transaction_type.sign } }
    end
  ...
  test "should update transaction_type" do
    patch transaction_type_url(@transaction_type), params: { transaction_type: { description: @transaction_type.description, kind: @transaction_type.kind, sign: @transaction_type.sign } }
